=======================================================
Date:             28th of January 2001.
file:             sb-stratotga.zip
author:           Sock 
...
Instructions for using the Stratosphere Skybox
----------------------------------------------
...
4. Close the file and open Q3Radiant and you should
   find on the texture menu the STRATOSPHERE subdirectory.
   
5. Choose the STRATOSPHERE subdirectory and you should find
   the sky texture ready for use.
   
6. If the editor displays 2 textures use the one
   called STRATO_SKYBOX. The other one is just so
